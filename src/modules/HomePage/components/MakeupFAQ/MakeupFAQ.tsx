...
const faqs = [
  {
    question: 'Що буде після оплати?',
    answer: 'Після оплати не залишайте сторінку, дочекайтеся і у вас зʼявиться посилання на телеграм канал із уроками.',
  },
  {
    question: 'Чи потрібен досвід у макіяжі?',
    answer: 'Ні, курс розрахований для навчання з нуля, для тих, хто ніколи не тримав у руках пензлик.',
  },
  {
    question: 'Скільки часу займає курс?',
    answer: 'Курс складається з 10 уроків, які можна проходити у вільному темпі.',
  },
  {
    question: 'Чи потрібно купувати дорогу косметику?',
    answer: 'Абсолютно ні! У чек-листах я зібрала багато класних бюджетних засобів. А почати можна з того, що у вас вже є.',
  },
  {
    question: 'Як проходить навчання?',
    answer: 'Це відеокурс з практичними уроками. Ви отримуєте доступ до усіх матеріалів, які можете переглядати скільки завгодно разів у зручний для вас час.',
  },
  {
    ...
    <section className={styles.faq}>
      <div className={styles.faq__container}>
        ...
        <div className={styles.faq__contact}>
          ...
          <a
            href="https://www.instagram.com/taniemua?igsh=NnV1dzFuNWd5bmp4&utm_source=qr"
            target="_blank"
