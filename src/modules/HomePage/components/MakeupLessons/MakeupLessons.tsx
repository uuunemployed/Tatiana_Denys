...
const lessonsData = [
 {
  ...
  {
    id: "10",
    title: "Бонус: Стрілки та Помилки",
    topics: [
      { text: "Як намалювати ", bold: "ідеальні стрілки ", rest: "різних видів?" },
      { text: "Найпоширеніші ", bold: "помилки ", rest: "в макіяжі та як їх виправити" },
      { text: "Лайфхаки для ідеального результату" },
    ],
    result: "Дізнаєтеся про типові помилки, навчитеся їх уникати та опануєте малювання стрілок.",
